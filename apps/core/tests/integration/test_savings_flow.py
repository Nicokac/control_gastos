...
class TestSavingCreationFlow:
    ...
    def test_create_saving_and_verify_in_list(self, authenticated_client, user):
...
class TestSavingMovementsFlow:
    ...
    def test_deposit_increases_balance(self, authenticated_client, user, saving):
    ...
    def test_multiple_deposits_accumulate(self, authenticated_client, user, saving):
    ...
    def test_withdrawal_decreases_balance(self, authenticated_client, user, saving_with_progress):
    ...
    def test_deposit_and_withdrawal_flow(self, authenticated_client, user, saving):
...
class TestSavingCompletionFlow:
    ...
    def test_saving_auto_completes_when_target_reached(self, authenticated_client, user, saving):
    ...
    def test_saving_completes_when_exceeding_target(self, authenticated_client, user, saving):
    ...
    def test_progress_percentage_calculation(self, authenticated_client, user, saving):

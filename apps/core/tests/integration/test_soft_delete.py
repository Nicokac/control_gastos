...
class TestSoftDeleteBehavior:
    ...
    def test_deleted_expense_not_in_list(
        self, authenticated_client, expense
    ):
    ...
    def test_deleted_expense_still_in_database(
        self, authenticated_client, expense
    ):
    ...
    def test_deleted_saving_movements_preserved(
...
class TestSoftDeleteRecovery:
    ...
    def test_soft_deleted_data_recoverable_via_all_objects(
        self, authenticated_client, expense
    ):
    ...
    def test_multiple_soft_deletes_tracked(
        ...
        # Crear varios gastos
        expenses = [
            expense_factory(user, expense_category, description=f'Gasto {i}')
            for i in range(3)
        ]

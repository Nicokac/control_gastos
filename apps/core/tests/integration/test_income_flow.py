...
class TestIncomeCreationFlow:
    ...
    def test_create_income_and_verify_in_list(
    ...
    def test_create_edit_delete_income_flow(
        self, authenticated_client, user, income_category
    ):
    ...
    def test_income_with_usd_currency_flow(
        self, authenticated_client, user, income_category
    ):
...
class TestIncomeBalanceCalculation:
    ...
    def test_multiple_incomes_sum_correctly(
        self, authenticated_client, user, income_category
    ):

...
class TestDashboardView:
    ...
    def test_login_required(self, client):
        ...
        # Probar ambos posibles namespaces
        try:
    ...
    def test_dashboard_has_context_data(self, authenticated_client, expense, income):
        ...
        possible_keys = [
            'total_income', 'income_total', 'ingresos',
            'total_expenses', 'expense_total', 'gastos',
            'balance', 'saldo',
    ...
    def test_dashboard_shows_current_month_data(
        ...
        expense_factory, income_factory
    ):
    ...
    def test_dashboard_excludes_other_user_data(
        ...
        expense_factory(
            ...
            description='Gasto Otro Usuario',

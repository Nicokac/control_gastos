...
class TestBudgetListView:
    ...
    def test_excludes_other_user_budgets(self, authenticated_client, other_user, expense_category_factory, budget_factory):
...
class TestBudgetUpdateView:
    ...
    def test_cannot_update_other_user_budget(self, authenticated_client, other_user, expense_category_factory, budget_factory):
...
class TestBudgetDeleteView:
    ...
    def test_cannot_delete_other_user_budget(self, authenticated_client, other_user, expense_category_factory, budget_factory):
